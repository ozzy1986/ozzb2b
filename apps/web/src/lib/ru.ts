const CATEGORY_RU: Record<string, string> = {
  ...
  bookkeeping: 'Ведение учета',
  'tax-advisory': 'Налоги',
  payroll: 'Зарплата и кадры',
...
const CATEGORY_DESCRIPTION_RU: Record<string, string> = {
  it: 'Разработка ПО, DevOps, QA, аналитика данных, AI/ML, кибербезопасность и UI/UX.',
  accounting:
    'Бухгалтерское обслуживание, налоги, зарплата, аудит и финансовая отчетность для бизнеса.',
