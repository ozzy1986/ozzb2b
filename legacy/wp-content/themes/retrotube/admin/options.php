...
function wpst_options() {
	$options = array(
		...
		'layout'     => 'boxed',
		'header'     => array(
			'name' => '<img src="https://www.wp-script.com/wp-content/themes/wps/img/products/themes/icons/' . strtolower( wp_get_theme()->get( 'Name' ) ) . '-icon.svg" width="20"> ' . wp_get_theme()->get( 'Name' ),
		),
		...
		$xbox->open_tab_item( 'tools' );
			$xbox->open_mixed_field(
				...
				$xbox->add_field(
					array(
						...
						'desc'    => sprintf( __( 'Display illustrated categories like on <a href="%1$s" target="_blank">%2$s</a> demo.', 'wpst' ), 'https://demo.wp-script.com/rtt/categories/', wp_get_theme()->get( 'Name' ) ),
						'grid'    => '3-of-6',
					)
				);
				$xbox->add_field(
					array(
						...
						// translators: %2$s: Current Theme name.
						'desc'    => sprintf( __( 'Display a tags list like on <a href="%1$s" target="_blank">%2$s</a> demo.', 'wpst' ), 'https://demo.wp-script.com/rtt/tags/', wp_get_theme()->get( 'Name' ) ),
						'grid'    => '3-of-6 last',
					)
				);
				$xbox->add_field(
					array(
						...
						// translators: %2$s: Current Theme name.
						'desc'    => sprintf( __( 'Display an actors list like on <a href="%1$s" target="_blank">%2$s</a> demo.', 'wpst' ), 'https://demo.wp-script.com/rtt/actors/', wp_get_theme()->get( 'Name' ) ),
						'grid'    => '3-of-6',
					)
				);
				$xbox->add_field(
					array(
						...
						// translators: %2$s: Current Theme name.
						'desc'    => sprintf( __( 'Allow users to submit videos like on <a href="%1$s" target="_blank">%2$s</a> demo.', 'wpst' ), 'https://demo.wp-script.com/rtt/submit-a-video/', wp_get_theme()->get( 'Name' ) ),
						'grid'    => '3-of-6 last',
					)
				);
				$xbox->add_field(
					array(
						...
						// translators: %2$s: Current Theme name.
						'desc'    => sprintf( __( 'Allow users to modify their profile like on <a href="%1$s" target="_blank">%2$s</a> demo.', 'wpst' ), 'https://demo.wp-script.com/rtt/my-profile/', wp_get_theme()->get( 'Name' ) ),
						'grid'    => '3-of-6',
					)
				);
				$xbox->add_field(
					array(
						...
						// translators: %2$s: Current Theme name.
						'desc'    => sprintf( __( 'Create separate blog page like on <a href="%1$s" target="_blank">%2$s</a> demo.', 'wpst' ), 'https://demo.wp-script.com/rtt/blog/', wp_get_theme()->get( 'Name' ) ),
						'grid'    => '3-of-6 last',
					)
				);
			$xbox->close_mixed_field();
			...
			$xbox->add_field(
				array(
					...
					'desc'    => sprintf( __( 'Create a <a href="%1$s" target="_blank">menu</a> like on <a href="%2$s" target="_blank">%3$s</a> demo.', 'wpst' ), get_admin_url() . 'nav-menus.php', 'https://demo.wp-script.com/rtt/', wp_get_theme()->get( 'Name' ) ),
					'grid'    => '2-of-6',
				)
			);
			...
			$xbox->add_field(
				array(
					...
					// translators: %2$s: WP-Script RetroTube Demo URL.
					// translators: %3$s: Current Theme name.
					'desc'    => sprintf( __( 'Create <a href="%1$s" target="_blank">widgets</a> like on <a href="%2$s" target="_blank">%3$s</a> demo.', 'wpst' ), get_admin_url() . 'widgets.php', 'https://demo.wp-script.com/rtt/', wp_get_theme()->get( 'Name' ) ),
					'grid'    => '2-of-6',
				)
			);
